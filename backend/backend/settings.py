...
SECRET_KEY = 'django-insecure-)^bxtmn*z@u9&olaz92fn_jv89ye3sllu6@9uex2xvyw-#q03x'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', "todo1.up.railway.app"]
...
# Whitelist the React port, otherwise its blocked
